...
from housing_finder_app.models import User, Project, ProjectUser
from housing_finder_app.models import db
from housing_finder_app.auth.forms import ChangePasswordForm
...
def edit_profile():
    ...
    if request.method == 'POST':
        ...
        # Update the photo on user profile
            ...
            uploaded_file.save(f"housing_finder_app/static/images/img_profile/{filename}")
